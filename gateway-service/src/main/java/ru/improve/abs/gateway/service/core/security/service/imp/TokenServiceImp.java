...
import static ru.improve.abs.gateway.service.api.exception.ErrorCode.ILLEGAL_VALUE;
import static ru.improve.abs.gateway.service.util.SecurityUtil.SESSION_ID_CLAIM;
import static ru.improve.abs.gateway.service.util.message.MessageKeys.SESSION_TOKEN_INVALID;
