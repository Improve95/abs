...
import ru.improve.abs.processing.service.api.controller.spec.AdminControllerSpec;
...
import static ru.improve.abs.processing.service.api.ApiPaths.ADD;
import static ru.improve.abs.processing.service.api.ApiPaths.ADMIN;
import static ru.improve.abs.processing.service.api.ApiPaths.ID;
import static ru.improve.abs.processing.service.api.ApiPaths.REMOVE;
import static ru.improve.abs.processing.service.api.ApiPaths.ROLES;
import static ru.improve.abs.processing.service.api.ApiPaths.ROLE_ID;
import static ru.improve.abs.processing.service.api.ApiPaths.USER_ID;
import static ru.improve.abs.processing.service.util.SecurityUtil.ADMIN_ROLE;
