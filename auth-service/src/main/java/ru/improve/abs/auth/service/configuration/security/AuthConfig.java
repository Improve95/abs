...
import ru.improve.abs.auth.service.api.exception.CustomAuthEntryPoint;
import ru.improve.abs.auth.service.core.security.AuthTokenFilter;
...
import static ru.improve.abs.auth.service.util.SecurityUtil.OPERATOR_ROLE;
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(
                        auth -> auth
                                ...
                                .requestMatchers(HttpMethod.GET, AUTH + TOKEN_EXCHANGE + TOKEN).permitAll()
