...
import ru.improve.abs.service.api.controller.spec.AdminControllerSpec;
import ru.improve.abs.service.api.dto.user.UserResponse;
import ru.improve.abs.service.core.service.UserService;

import static ru.improve.abs.service.api.ApiPaths.ADD;
import static ru.improve.abs.service.api.ApiPaths.ADMIN;
import static ru.improve.abs.service.api.ApiPaths.ID;
import static ru.improve.abs.service.api.ApiPaths.REMOVE;
import static ru.improve.abs.service.api.ApiPaths.ROLES;
import static ru.improve.abs.service.api.ApiPaths.ROLE_ID;
import static ru.improve.abs.service.api.ApiPaths.USER_ID;
